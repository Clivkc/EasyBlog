...
<body class="dark:bg-neutral-900">
    ...
    <div class="container mx-auto text-center">
        ...
        <a href="https://ipv6test.wcode.net/?q=%5B2606%3A50c0%3A8000%3A%3A153%5D" target="_blank">
            <img src="https://ipv6test.wcode.net/badges/ipv6.svg?host=%5B2606%3A50c0%3A8000%3A%3A153%5D" alt="" style="max-width: 100%; height: 24px;"/>
        </a>
        </p>
    </div>
    </div>
