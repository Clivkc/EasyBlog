...
<body class="dark:bg-neutral-900">
    ...
    <div class="container mx-auto flex items-center justify-between">
        ...
        <input id="searchText" placeholder="TCK小站" class="px-4 py-2 border border-gray-600 rounded-lg dark:bg-neutral-800 text-white focus:outline-none" />
    ...
    <div class="container mx-auto text-center">
        ...
        @{Name}
        <a class="text-blue-600" target="_blank" href="https://clivkc.github.io/EasyBlog/">Powered by Ater Blog</a>
        </p>
    </div>
    </div>
</body>
